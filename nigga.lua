...
local ESP_SETTINGS = {
    ...
    BoxColor = Color3.new(255, 198, 254),
    BoxTransparency = 0.5,  -- Adicione esta linha para a transparência do preenchimento
...
local function createEsp(player)
    local esp = {
        ...
        box = create("Square", {
            ...
            Thickness = 1,
            Filled = true,  -- Mantenha Filled como true para permitir a transparência
            Transparency = ESP_SETTINGS.BoxTransparency  -- Utilize a transparência personalizada
        }),
        name = create("Text", {
                ...
                if onScreen then
                    ...
                    if ESP_SETTINGS.ShowBox and ESP_SETTINGS.Enabled then
                        if ESP_SETTINGS.BoxType == "2D" then
                            ...
                            esp.box.Transparency = ESP_SETTINGS.BoxTransparency  -- Utilize a transparência personalizada
                    ...
                    -- Atualize os outros elementos do ESP (saúde, distância, etc.) da mesma forma
                else
                    esp.name.Visible = false
                    esp.box.Visible = false
                    esp.boxOutline.Visible = false
